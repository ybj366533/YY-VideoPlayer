...
class BuilderParams {
    ...
    BuilderParams(Context context) {
        ...
        this.mBackgroundTrackSize = IndicatorUtils.dp2px(mContext, 3);
        this.mProgressTrackSize = IndicatorUtils.dp2px(mContext, 3);
        this.mCacheProgressTrackSize = IndicatorUtils.dp2px(mContext,3);
    ...
    BuilderParams copy(BuilderParams p) {
        ...
        this.mCacheProgress = p.mCacheProgress;
        ...
        this.mCacheProgressTrackSize = p.mCacheProgressTrackSize;
        this.mBackgroundTrackColor = p.mBackgroundTrackColor;
        this.mProgressTrackColor = p.mProgressTrackColor;
        this.mCacheProgressTrackColor = p.mCacheProgressTrackColor;
