...
public class PageOptionBuilder {
     ...
     */
    public PageOptionBuilder setAutoFullWithSize(boolean autoFullWithSize) {
     ...
     */
    public PageOptionBuilder setShowFullAnimation(boolean showFullAnimation) {
     ...
     * 设置循环
     */
    public PageOptionBuilder setLooping(boolean looping) {
     ...
     * @param listener
     */
    public PageOptionBuilder setVideoPlayerListener(VideoPlayerListener listener) {
     ...
     * 是否开启自动旋转
     */
    public PageOptionBuilder setRotateViewAuto(boolean rotateViewAuto) {
     ...
     */
    public PageOptionBuilder setLockLand(boolean lockLand) {
     ...
     * 播放速度
     */
    public PageOptionBuilder setSpeed(float speed) {
        this.mSpeed = speed;
        return this;
    }
     ...
     * 变声不变调
     */
    public PageOptionBuilder setSoundTouch(boolean soundTouch) {
     ...
     * 全屏隐藏虚拟按键，默认打开
     */
    public PageOptionBuilder setHideKey(boolean hideKey) {
     ...
     * 默认true
     */
    public PageOptionBuilder setIsTouchWiget(boolean isTouchWiget) {
     ...
     * 默认 true
     */
    public PageOptionBuilder setIsTouchWigetFull(boolean isTouchWigetFull) {
     ...
     * 是否需要显示流量提示,默认true
     */
    public PageOptionBuilder setNeedShowWifiTip(boolean needShowWifiTip) {
     ...
     * 不设置使用默认
     */
    public PageOptionBuilder setEnlargeImageRes(int mEnlargeImageRes) {
     ...
     * 不设置使用默认
     */
    public PageOptionBuilder setShrinkImageRes(int mShrinkImageRes) {
     ...
     */
    public PageOptionBuilder setShowPauseCover(boolean showPauseCover) {
     ...
     */
    public PageOptionBuilder setSeekRatio(float seekRatio) {
        if (seekRatio < 0) {
            return this;
        }
     ...
     */
    public PageOptionBuilder setRotateWithSystem(boolean rotateWithSystem) {
     ...
     */
    public PageOptionBuilder setPlayTag(String playTag) {
     ...
     * 设置播放位置防止错位
     */
    public PageOptionBuilder setPlayPosition(int playPosition) {
     ...
     */
    public PageOptionBuilder setSeekOnStart(long seekOnStart) {
     ...
     * @param url
     */
    public PageOptionBuilder setUrl(String url) {
        this.mUrl = url;
        return this;
    }
     ...
     * @param videoTitle
     */
    public PageOptionBuilder setVideoTitle(String videoTitle) {
     ...
     * @param cacheWithPlay
     */
    public PageOptionBuilder setCacheWithPlay(boolean cacheWithPlay) {
     ...
     */
    public PageOptionBuilder setStartAfterPrepared(boolean startAfterPrepared) {
     ...
     */
    public PageOptionBuilder setReleaseWhenLossAudio(boolean releaseWhenLossAudio) {
     ...
     * @param cachePath
     */
    public PageOptionBuilder setCachePath(File cachePath) {
     ...
     * @param mapHeadData
     */
    public PageOptionBuilder setMapHeadData(Map<String, String> mapHeadData) {
     ...
     * 进度回调
     */
    public PageOptionBuilder setGSYVideoProgressListener(VideoProgressListener videoProgressListener) {
     ...
     * 设置封面
     */
    public PageOptionBuilder setThumbImageView(View view) {
     ...
     * 底部进度条-弹出的
     */
    public PageOptionBuilder setBottomShowProgressBarDrawable(Drawable drawable, Drawable thumb) {
     ...
     * 底部进度条-非弹出
     */
    public PageOptionBuilder setBottomProgressBarDrawable(Drawable drawable) {
     ...
     * 声音进度条
     */
    public PageOptionBuilder setDialogVolumeProgressBar(Drawable drawable) {
     ...
     * 中间进度条
     */
    public PageOptionBuilder setDialogProgressBar(Drawable drawable) {
     ...
     * 中间进度条字体颜色
     */
    public PageOptionBuilder setDialogProgressColor(int highLightColor, int normalColor) {
     ...
     * 是否点击封面可以播放
     */
    public PageOptionBuilder setThumbPlay(boolean thumbPlay) {
     ...
     */
    public PageOptionBuilder setNeedLockFull(boolean needLoadFull) {
     ...
     * 锁屏点击
     */
    public PageOptionBuilder setLockClickListener(LockClickListener lockClickListener) {
     ...
     */
    public PageOptionBuilder setDismissControlTime(int dismissControlTime) {
     ...
     * 设置滤镜效果
     */
    public PageOptionBuilder setEffectFilter(MiguVideoGLView.ShaderInterface effectFilter) {
     ...
     * 在播放前才真正执行setup
     */
    public PageOptionBuilder setSetUpLazy(boolean setUpLazy) {
        this.mSetUpLazy = setUpLazy;
        return this;
    }

    public PageOptionBuilder setFullHideActionBar(boolean actionBar) {
        this.mActionBar = actionBar;
        return this;
    }

    public PageOptionBuilder setFullHideStatusBar(boolean statusBar) {
        this.mStatusBar = statusBar;
        return this;
    }

    public void build(FullScreenVideoView mVideoPlayer) {
        ...
        if (listener != null) {
            mVideoPlayer.setVideoPlayerListener(listener);
        }
//        if (mVideoProgressListener != null) {
//            mVideoPlayer.setVideoProgressListener(mVideoProgressListener);
//        }
        ...
        mVideoPlayer.setUp(mUrl, mCacheWithPlay, mCachePath, mMapHeadData);
    }
