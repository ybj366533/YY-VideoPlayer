...
import com.ybj366533.videoplayer.PreViewManager;
import com.ybj366533.videoplayer.R;
import com.ybj366533.videoplayer.render.view.MiGuTextureView;
...
public class CustomVideoPlayer extends StandardVideoPlayer {
    ...
    private MiGuTextureView mPreviewTexture;
    ...
    protected void addTextureView() {
        ...
        mPreviewTexture = new MiGuTextureView(getActivityContext());
    ...
    public BaseVideoPlayer startWindowFullscreen(Context context, boolean actionBar, boolean statusBar) {
        ...
        CustomVideoPlayer customGSYVideoPlayer = (CustomVideoPlayer) gsyBaseVideoPlayer;
