...
import com.migu.videoplayer.R;
import com.migu.videoplayer.model.VideoEntity;
...
public class SampleADVideoPlayer extends ListVideoPlayer {
     ...
     * @return
     */
    public boolean setAdUp(ArrayList<ADVideoEntity> url, boolean cacheWithPlay, int position) {
        return setUp((ArrayList<VideoEntity>) url.clone(), cacheWithPlay, position);
    }
     ...
     * @return
     */
    public boolean setAdUp(ArrayList<ADVideoEntity> url, boolean cacheWithPlay, int position, File cachePath) {
        return setUp((ArrayList<VideoEntity>) url.clone(), cacheWithPlay, position, cachePath);
    }
     ...
     * @return
     */
    public boolean setAdUp(ArrayList<ADVideoEntity> url, boolean cacheWithPlay, int position, File cachePath, Map<String, String> mapHeadData) {
        return setUp((ArrayList<VideoEntity>) url.clone(), cacheWithPlay, position, cachePath, mapHeadData);
    }

    public static class ADVideoEntity extends VideoEntity {
        /**
         * 正常
         */
         ...
         */
        public ADVideoEntity(String url, String title, int type) {
         ...
         * @param isSkip 是否跳过
         */
        public ADVideoEntity(String url, String title, int type, boolean isSkip) {
            super(url, title);
            this.mType = type;
            this.isSkip = isSkip;
        }
