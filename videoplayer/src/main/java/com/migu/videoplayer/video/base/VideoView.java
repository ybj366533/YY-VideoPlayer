package com.migu.videoplayer.video.base;
...
import com.migu.videoplayer.utils.NetInfoModule;
...
public abstract class VideoView extends MiGuTextureRenderView implements MediaPlayerListener {
    ...
    protected void init(Context context) {
        ...
        mTextureViewContainer = (ViewGroup) findViewById(com.migu.videoplayer.R.id.surface_container);
        if (isInEditMode())
            return;
