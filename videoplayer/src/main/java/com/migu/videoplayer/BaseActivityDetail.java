 ...
 * 详情模式播放页面基础类
 */
public abstract class BaseActivityDetail<T extends BaseVideoPlayer> extends Activity implements VideoAllCallBack {
     ...
     * 配置播放器
     */
    public abstract VideoOptionBuilder getGSYVideoOptionBuilder();
