package com.migu.videoplayer.render.glrender;
...
import com.migu.videoplayer.render.view.listener.MiGuGLSurfaceListener;
import com.migu.videoplayer.render.view.listener.VideoGLRenderErrorListener;
...
public abstract class VideoGLViewBaseRender implements GLSurfaceView.Renderer, SurfaceTexture.OnFrameAvailableListener {
    ...
    protected MiGuGLSurfaceListener mGSYSurfaceListener;
    ...
    public void setGSYSurfaceListener(MiGuGLSurfaceListener onSurfaceListener) {
     ...
     * @param shaderEffect
     */
    public void setEffect(MiguVideoGLView.ShaderInterface shaderEffect) {
    }


    public MiguVideoGLView.ShaderInterface getEffect() {
        return null;
    }
