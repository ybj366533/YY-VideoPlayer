...
public class SmallVideoHelper {
     ...
     * 播放配置
     */
    private SmallVideoHelperBuilder gsyVideoOptionBuilder;
    /**
     * 上下文
     */
     ...
     * 设置配置
     */
    public void setGsyVideoOptionBuilder(SmallVideoHelperBuilder gsyVideoOptionBuilder) {
        this.gsyVideoOptionBuilder = gsyVideoOptionBuilder;
    }

    public VideoOptionBuilder getGsyVideoOptionBuilder() {
     ...
     * 配置
     */
    public static class SmallVideoHelperBuilder extends VideoOptionBuilder {
        ...
        public SmallVideoHelperBuilder setHideActionBar(boolean hideActionBar) {
        ...
        public SmallVideoHelperBuilder setHideStatusBar(boolean hideStatusBar) {
        ...
        public MiguVideoGLView.ShaderInterface getEffectFilter() {
            return mEffectFilter;
        }

        public VideoProgressListener getGSYVideoProgressListener() {
