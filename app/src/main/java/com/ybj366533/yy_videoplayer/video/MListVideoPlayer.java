...
public class MListVideoPlayer extends StandardVideoPlayer {
     ...
     */
    public MListVideoPlayer(Context context, Boolean fullFlag) {
        super(context, fullFlag);
    }

    public MListVideoPlayer(Context context) {
        super(context);
    }

    public MListVideoPlayer(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    protected void cloneParams(MVideoPlayer from, MVideoPlayer to) {
        ...
        MListVideoPlayer sf = (MListVideoPlayer) from;
        MListVideoPlayer st = (MListVideoPlayer) to;
    ...
    public MVideoPlayer startWindowFullscreen(Context context, boolean actionBar, boolean statusBar) {
        ...
        if (gsyMiGuVideoPlayer != null) {
            MListVideoPlayer listGSYVideoPlayer = (MListVideoPlayer) gsyMiGuVideoPlayer;
    ...
    protected void resolveNormalVideoShow(View oldF, ViewGroup vp, MVideoPlayer gsyVideoPlayer) {
        if (gsyVideoPlayer != null) {
            MListVideoPlayer listGSYVideoPlayer = (MListVideoPlayer) gsyVideoPlayer;
            PlayerVideoModel videoEntity = mUriList.get(mPlayPosition);
            if (!TextUtils.isEmpty(videoEntity.getName())) {
                mTitleTextView.setText(videoEntity.getName());
            }
