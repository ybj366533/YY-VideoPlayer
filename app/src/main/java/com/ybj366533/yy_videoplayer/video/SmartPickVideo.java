...
public class SmartPickVideo extends StandardVideoPlayer {
    ...
    private VideoManager mTmpManager;
    ...
    private MediaPlayerListener gsyMediaPlayerListener = new MediaPlayerListener() {
        @Override
        ...
        public void onSeekComplete() {
            if (mTmpManager != null) {
                ...
                VideoManager.changeManager(mTmpManager);
    ...
    private void resolveStartChange(int position) {
        ...
        if (mSourcePosition != position) {
            if ((mCurrentState == BaseVideoPlayer.CURRENT_STATE_PLAYING
                    || mCurrentState == BaseVideoPlayer.CURRENT_STATE_PAUSE)
                ...
                //创建临时管理器执行加载播放
                mTmpManager = VideoManager.tmpInstance(gsyMediaPlayerListener);
